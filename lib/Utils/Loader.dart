...
class LoaderTwo extends StatefulWidget {
 ...
 static const colred = Color(0xffed151e);

  LoaderTwo({Key key, this.centralDotColor = Colors.white, this.dotOneColor=colred, this.dotTwoColor=Colors.white, this.dotThreeColor=colred, this.dotFourColor=Colors.white, this.dotFiveColor=colred, this.dotSixColor=Colors.white, this.dotSevenColor=colred, this.dotEightColor=Colors.white, this.centralDotRadius=25.0, this.spanRadius=15.0, this.duration = const Duration(seconds: 2), this.outerDotRadius = 5.0 }) : super(key: key);
